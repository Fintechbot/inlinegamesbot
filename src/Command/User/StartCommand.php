...
class StartCommand extends UserCommand
{
    ...
    public function execute(): ServerResponse
    {
        ...
        $text .= '<b>' . __('Hey!') . '</b>' . PHP_EOL;
        $text .= __('To play game, start a message with {USAGE} in any of your chats or click the {BUTTON} button and then select a chat to play in.', ['{USAGE}' => '<b>\'@' . $this->getTelegram()->getBotUsername() . ' ...\'</b>', '{BUTTON}' => '<b>\'' . __('Play') . '\'</b>']);
